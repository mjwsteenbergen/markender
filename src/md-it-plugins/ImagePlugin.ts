import { State, Token, MarkdownIt } from "./MarkdownItTypings";
...
module.exports = function mdImagePlugin(md: MarkdownIt, options: any) {
    md.renderer.rules.mdimage = mdImage;
    md.inline.ruler.after('escape', 'linker', mdImage);
    //console.error("hi");
};

function mdImage(state: State, silent: boolean) {
    var attrs,
        code,
        content,
        label,
